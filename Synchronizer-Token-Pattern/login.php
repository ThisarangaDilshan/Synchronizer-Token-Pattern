                ...
                <form method="POST" class="form-con">
                    <div class="form-group">
                       <h2>Transfer Money</h2>
                        ...
                        <input type="number" name="username" type="username" class="form-control"placeholder="XXXX XXXX XXXX" aria-describedby="Username Help">
                       
                    </div>
                    <div class="form-group">
                        <label for="amount1">Amount</label>
                       
                        <input type="number" name="password"  type="password" placeholder="LKR:0.00" class="form-control" id="amount1"></br>
